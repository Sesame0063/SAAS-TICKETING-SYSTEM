...
export default function AgentQueuePage() {
  ...
  return (
    <div className="space-y-8 p-8">
      ...
      <div className="flex flex-col gap-4 rounded-2xl bg-white p-5 shadow md:flex-row">
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          ...
          {filteredTickets.map((ticket)=>(
            <div
              key={ticket.id}
              className="rounded-2xl border bg-white p-5 shadow-sm hover:border-blue-400 hover:shadow-md transition"
            >
